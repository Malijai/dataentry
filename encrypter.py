...
#toujours des problemes d'encryptage: Error: Plaintext is too long.
...
class Encrypter(object):
    ...
    def read_key(self, key_filename):
        private_key = RSA.importKey(open(key_filename).read())
        return private_key
    ...
    def decrypt(self, ciphertext, private_key):
        ...
        decripted = decript_cypher.decrypt(b64decode(ciphertext)).decode('utf-8')
        return decripted