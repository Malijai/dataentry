...
from .views import select_personne, saverepetntp2, saventp2, questions_pdf, ffait_csv, decrypt, verifie_csv, \
    ...
    fait_entete_ntp2_pandas, corrigedob, listedob, fait_entete_ntp2_R, lissecret
...
urlpatterns = [
    ...
    path('csv/<int:province>/<int:questionnaire>/<int:tous>/', prepare_csv, name='prepare_csv'),
    path('csv/<int:province>/<int:questionnaire>/<int:iteration>/<int:seuil>/<int:tous>/', ffait_csv, name='do_csv'),
