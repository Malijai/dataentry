...
urlpatterns = [
    ...
    path('csv/<int:province>/<int:questionnaire>/<int:seuil>/', prepare_csv, name='prepare_csv'),
    path('csv/<int:province>/<int:questionnaire>/<int:iteration>/<int:seuil>/1', ffait_csv_rev, name='do_csv'),
